...
//     let k=parseInt(prompt("Enter the no of rotation"))
//     let rotat=(k)=>{
//         for(let i=0;i<k;i++){
//             let value=arr.pop()
//             arr.push(value)
...
//   return a - b;
// };
// function shortedArray(arr, arr1) {
//   if (arr !== asendingOder && arr1 !== asendingOder) {
//     let arrShort = arr.sort(asendingOder);
//     let arr1Sort = arr1.sort(asendingOder);
//     let arrFull = arrShort.concat(arr1Sort);
//     return arrFull.sort(asendingOder);
//   }
//   return arrFull.sort(asendingOder);
// }
// console.log(shortedArray(arr, arr1));
